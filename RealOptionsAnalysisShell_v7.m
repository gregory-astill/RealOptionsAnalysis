...
graphs = 1;                     %Turns on/off graph (mc_sigma)
...
MC= 1000;                        %Number of Monte Carlo simulations in mc_sigma
N1= 15;                         %Investment lifetime
J   = 1;                        %Number of firms in the industry
...
%          pause;
        for j=1:J
            ...
            if firmj(j,1,sim)==0                %Firms haven't adopted
                ...
                s = mc_sigma_v10(testR, rho, ejbar, alpha, N1, N, MC, graphs);              
