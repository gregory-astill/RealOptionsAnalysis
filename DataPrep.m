...
%Previously named Real Options Analysis Shell
%
%This code transforms raw distributional statistics into draws for one firm
%in N time periods. 
%
...
function Dataout = DataPrep(datafile, datafile2, N, subsidy)
...
%12 elect_retailp	
%13 coprodau
generatorcapacity = .8; % median value kwcapau = .16
...
Dataout = [K,C,NinState,NnextState,EnvValue];
%savefile = 'Ksim.mat';
%save(savefile, 'Kout');
